...
const Product_Style_Four = () => {
  return (
    <div>

      <div className='bg-pink-50'>
        <div className='container xl:p-16 lg:p-7 md:p-4 max-sm:p-10'>
      ...
      <div className='grid xl:grid-cols-4 lg:grid-cols-4 md:grid-cols-4 max-sm:grid-cols-2 xl:mt-14 lg:mt-12 md:mt-8 max-sm:mt-7 gap-4 container xl:p-16 lg:p-7 md:p-4 max-sm:p-10  '>
        ...
        <div className='relative primary-img'>
          ...
          <div>
            ...
            <p className='text-slate-500 inline-block ms-2'>$150</p>
          </div>
        ...
        <div className='relative'>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2023/01/sports-slacks.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className=''>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2023/01/grey-hill.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className=''>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/cotton-bucket-hat.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className='relative'>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/jute-bag-1.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className=''>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/Round-neck-slevless.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className=''>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/sneakers.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className='relative'>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/sports-wear.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className='relative'>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2023/01/Casual-T-shirts-beige.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className='relative'>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/Leather-Handbag.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
        ...
        <div className='relative'>
          <div className='overflow-hidden inline-block xl:w-[290px] xl:h-[400px]'>
            <img className='object-fill xl:h-full xl:w-full hover:scale-110 duration-500 ease-in-out' src="https://emart.wpthemedemos.com/fashion-hub/wp-content/uploads/sites/4/2022/12/Grey-Formal-Shirt.webp" alt="" />
          </div>
          <div>
            <p className='text-xl font-semibold mt-2'>Grey tote bag</p>
            <del className='text-slate-500 inline-block mt-1'>$170</del>
...
export default Product_Style_Four
