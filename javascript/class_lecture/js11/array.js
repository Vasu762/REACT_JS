...

{
   ...
   //  let maparry2 = maparry.map((vasu) => vasu   *2);
   //  console.log(maparry);  
...

{
   ...
   let fillarray2 = fillarray.fill("vasu" , 1)
   let fillarray3 = fillarray.fill("vasu" , 2)
   let fillarray4 = fillarray.fill("vasu" , 4)
...

{
   ...
   // console.log(arry.valueOf());   //(9) [1, 2, 3, 4, 5, 6, 7, 8, 9]
}
