...

{
  ...
  // console.log(Object3);     //{num3: '3', num1: '1', num2: '2'}

  // let AllObj = Obj1 = Obj2

  // console.log(AllObj);   // {num3: '3', num1: '1', num2: '2'}
  // console.log(Obj2);     // {num3: '3', num1: '1', num2: '2'} 
  // console.log(Obj1);     // {num3: '3', num1: '1', num2: '2'}
...

{
  ...
  // console.log(Object.entries(obj));  //entries key assignding order     
...

{
  ...
  // let Obj3 = Object.is(Obj1 , Obj1)     //always two object are not same //object key and value same but two object are not same 
