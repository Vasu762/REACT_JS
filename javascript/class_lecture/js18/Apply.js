...
{//////////////
  ...
  function grow(wish, message) {
    return `${this.firstName} , ${wish}. ${message}`;            //this.firstName
  }

  const result = grow.apply(NewObj, ["Good Morning", "How Are You"]);    //NewObj
  console.log(result);
}
...
let NewArry = Array1.push.apply(Array1, Array2)  //way array1 and arry2
