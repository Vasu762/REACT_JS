...
// console.log(String10);          //E MOST SIMPLE FOO.
// console.log(String11);          //E FOO.
// console.log(String12);          // nagative value
// console.log(String13);          //
// console.log(String14);          
// console.log(String15);          //RE MOST SIMPL
...
// console.log(String17);          //OST SIMPLE FOO.
// console.log(String18);          //OST SIMPLE FOO.
// console.log(String19);          //WHAT ARE MOST SIMPLE FOO.
// console.log(String20);          //IMPLE FOO.
// console.log(String21);          //OST SIMPLE
// console.log(String22);              //WHAT ARE M
...
// let String57 = String56.search("t")
...
// let String56 = "Why Need Form Valiadation In Web Development"
// console.log(String56);
// let String57 = String56.startsWith("W");
// console.log(String57);
